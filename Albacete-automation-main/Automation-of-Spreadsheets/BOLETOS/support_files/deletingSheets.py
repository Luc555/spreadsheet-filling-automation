#Biblioteca para tratamento de arquivos e diretórios
import os
...
try:
        ...
        for folder, subfolders, files in os.walk("C:/Albacete-automation/Automation-of-Spreadsheets/BOLETOS/planilha_weg"):
