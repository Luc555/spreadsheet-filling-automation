...
#Computador trabalho
credentials = ServiceAccountCredentials.from_json_keyfile_name('E:/Albacete-automation/Albacete-automation/Credential_google.json', scope)

#Computador casa
#credentials = ServiceAccountCredentials.from_json_keyfile_name('E:/Albacete-automation-main/Albacete-automation/Credential_google.json', scope)
...
#Computador trabalho
planilha01 = pd.read_excel("E:/Albacete-automation/Albacete-automation/DATABASE/Parametros-dos-motores.xlsx", sheet_name="Parâmetros dos Motores")

#Computador casa
#planilha01 = pd.read_excel("E:/Albacete-automation-main/Albacete-automation/DATABASE/Parametros-dos-motores.xlsx", sheet_name="Parâmetros dos Motores")

#Computador trabalho
"""
wegInvoice = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice.xml'
wegInvoice0 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice0.xml'
wegInvoice1 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice1.xml'
wegInvoice2 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice2.xml'
wegInvoice3 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice3.xml'
wegInvoice4 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice4.xml'
wegInvoice5 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice5.xml'
wegInvoice6 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice6.xml'
wegInvoice7 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice7.xml'
wegInvoice8 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice8.xml'
wegInvoice9 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice9.xml'
wegInvoice10 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice10.xml'
wegInvoice11 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice11.xml'
wegInvoice12 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice12.xml'
wegInvoice13 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice13.xml'
wegInvoice14 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice14.xml'
wegInvoice15 = 'E:/Albacete-automation-main/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE/wegInvoice15.xml'
"""
...
for file in os.listdir("E:/Albacete-automation/Albacete-automation/Automation-of-Spreadsheets/WEG-INVOICE"):
    ...
    #Utilizada para obter a referência do produto    
                ...
                if validate == True:
                        ...
                        if len(clienteOrderLoop) == 1:
                                ...
                                invoiceZeroListLoopOne=invoiceZeroListLoopOne.flatten().tolist()
                                print( 'invoice'+i+': ',invoiceZeroListLoopOne)
                                print('\n')
                                invoiceZeroListLoopTwo=invoiceZeroListLoopTwo.flatten().tolist()
                                print( 'invoice'+str(i)+': ',invoiceZeroListLoopTwo)
                                print('\n')   
...
#Utilizada para obter a referência do produto    
                ...
                if validate == True:
                        invoiceZeroList = np.array([nota+clienteOrderLoop[0]+date+['empty']+['empty']+['empty']+amountOrdered+['empty']+['empty']+['empty']])
                        invoiceZeroList=invoiceZeroList.flatten().tolist()
                        print('invoice'+str(i)+'r(i)+', invoiceZeroList)
                        print('\n')
                        ...
                        if len(clienteOrderLoop) == 1:
                                ...
                                invoiceZeroList=invoiceZeroList.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+',invoiceZeroList)
                                print('\n')
                                ...
                                invoiceZeroListLoopOne=invoiceZeroListLoopOne.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+',invoiceZeroListLoopOne)
                                print('\n')
                                invoiceZeroListLoopTwo=invoiceZeroListLoopTwo.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+',invoiceZeroListLoopTwo)
                                print('\n')   
                                invoiceZeroListLoopThree=invoiceZeroListLoopThree.flatten().tolist()
                                print( 'invoice'+str(i)+',invoiceZeroListLoopThree)
                                print('\n')
                                invoiceZeroListLoopFour=invoiceZeroListLoopFour.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+',invoiceZeroListLoopFour)
                                print('\n')
                                worksheet.append_row(invoiceZeroListLoopOne, value_input_option='USER_ENTERED')
                                worksheet.append_row(invoiceZeroListLoopTwo, value_input_option='USER_ENTERED')
                                worksheet.append_row(invoiceZeroListLoopThree, value_input_option='USER_ENTERED')
                                ...
                                print('\n')   
                                invoiceZeroListLoopThree=invoiceZeroListLoopThree.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+',invoiceZeroListLoopThree)
                                print('\n')
                                invoiceZeroListLoopFour=invoiceZeroListLoopFour.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+',invoiceZeroListLoopFour)
                                print('\n')
                                invoiceZeroListLoopFive=invoiceZeroListLoopFive.flatten().tolist()
                                print( 'invoice'+str(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+'r(i)+',invoiceZeroListLoopFive)
                                print('\n')
                                worksheet.append_row(invoiceZeroListLoopOne, value_input_option='USER_ENTERED')
                                worksheet.append_row(invoiceZeroListLoopTwo, value_input_option='USER_ENTERED')
                                worksheet.append_row(invoiceZeroListLoopThree, value_input_option='USER_ENTERED')
